...
namespace AgDeViagens.Controllers
{
    public class DestinoController : Controller
    {
        ...
        public DestinoController(MBancoDeDados context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Local,Data,Valor")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Local,Data,Valor")] Destino destino)
        {
            if (id != destino.Id)
            {
                return NotFound();
